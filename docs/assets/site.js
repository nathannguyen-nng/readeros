(() => {
  ...
  const messages = {
    en: {
      ...
      homeTitle: "readerOS Tools",
      homeSubtitle: "Small browser tools for readerOS. Everything runs locally in your browser.",
      latestFirmware: "Latest firmware: 1.0.0.1-readeros",
      homeFlash: "Auto Flash",
      homeStats: "Reading Stats Editor",
      homeTools: "Tools",
      homeGithub: "GitHub",
      toolsTitle: "Tools",
      toolsSubtitle: "Useful browser tools for readerOS plus external utilities that fit the Xteink workflow.",
      toolsStatsTitle: "readerOS Reading Stats Editor",
      ...
      flashTitle: "Flash readerOS",
      flashSubtitle: "Install the latest readerOS firmware on your Xteink X3 or X4 from Chrome or Edge using Web Serial. It writes the inactive app partition and then switches boot to it.",
      ...
      flashButton: "Flash readerOS Firmware",
      flashButtonForDevice: "Flash readerOS Firmware for {device}",
      flashing: "Flashing...",
      ...
      flashComplete: "Flash complete. The device should reboot into readerOS.",
    ...
    es: {
      ...
      homeTitle: "Herramientas readerOS",
      homeSubtitle: "Pequeñas herramientas de navegador para readerOS. Todo se ejecuta localmente en tu navegador.",
      latestFirmware: "Último firmware: 1.0.0.1-readeros",
      homeFlash: "Auto Flash",
      homeStats: "Editor de estadísticas",
      homeTools: "Herramientas",
      homeGithub: "GitHub",
      toolsTitle: "Herramientas",
      toolsSubtitle: "Herramientas de navegador para readerOS y utilidades externas útiles para el flujo de trabajo Xteink.",
      toolsStatsTitle: "Editor de estadísticas de lectura readerOS",
      ...
      flashTitle: "Flashear readerOS",
      flashSubtitle: "Instala el último firmware readerOS en tu Xteink X3 o X4 desde Chrome o Edge usando Web Serial. Escribe la partición de app inactiva y luego arranca desde ella.",
      ...
      flashButton: "Flashear firmware readerOS",
      flashButtonForDevice: "Flashear firmware readerOS para {device}",
      flashing: "Flasheando...",
      ...
      flashComplete: "Flasheo completado. El dispositivo debería reiniciar en readerOS.",
  ...
  Object.assign(messages, {
    ca: {
      ...
      homeSubtitle: "Petites eines de navegador per a readerOS. Tot s'executa localment al navegador.", latestFirmware: "Últim firmware: 1.0.0.1-readeros", homeStats: "Editor d'estadístiques",
      flashEyebrow: "Instal·lador des del navegador", flashTitle: "Flasheja readerOS", flashSubtitle: "Instal·la l'últim firmware readerOS al teu Xteink X3/X4 des de Chrome o Edge amb Web Serial. Escriu la partició d'app inactiva i després hi canvia l'arrencada.",
      ...
      flashButton: "Flasheja el firmware readerOS", flashing: "Flashejant...", readyStatus: "A punt. En prémer Flash s'obrirà el selector de port sèrie del navegador.", choosePort: "Tria el port sèrie ESP32-C3 a l'avís del navegador.",
      ...
      flashComplete: "Flasheig completat. El dispositiu hauria de reiniciar amb readerOS.", flashStopped: "Flasheig aturat. Revisa el missatge anterior abans de tornar-ho a intentar.", downloadBin: "Descarrega .bin", communityFlasher: "Flasher comunitari",
    ...
    fr: {
      ...
      homeSubtitle: "Petits outils de navigateur pour readerOS. Tout s'exécute localement dans votre navigateur.", latestFirmware: "Dernier firmware : 1.0.0.1-readeros", homeStats: "Éditeur de statistiques",
      flashEyebrow: "Installateur dans le navigateur", flashTitle: "Flasher readerOS", flashSubtitle: "Installez le dernier firmware readerOS sur votre Xteink X3/X4 depuis Chrome ou Edge avec Web Serial. Il écrit la partition d'application inactive puis bascule le démarrage dessus.",
      ...
      flashButton: "Flasher le firmware readerOS", flashing: "Flash en cours...", readyStatus: "Prêt. Cliquer sur Flash ouvrira le sélecteur de port série du navigateur.", choosePort: "Choisissez le port série ESP32-C3 dans la fenêtre du navigateur.",
      ...
      flashComplete: "Flash terminé. L'appareil devrait redémarrer sur readerOS.", flashStopped: "Flash arrêté. Vérifiez le message ci-dessus avant de réessayer.", downloadBin: "Télécharger .bin", communityFlasher: "Flasher communautaire",
    ...
    de: {
      ...
      homeSubtitle: "Kleine Browser-Tools für readerOS. Alles läuft lokal in Ihrem Browser.", latestFirmware: "Neueste Firmware: 1.0.0.1-readeros", homeStats: "Statistik-Editor",
      flashEyebrow: "Browserbasierter Installer", flashTitle: "readerOS flashen", flashSubtitle: "Installieren Sie die neueste readerOS-Firmware auf Ihrem Xteink X3/X4 mit Chrome oder Edge und Web Serial. Die inaktive App-Partition wird beschrieben und anschließend als Bootziel gesetzt.",
      ...
      flashButton: "readerOS-Firmware flashen", flashing: "Flashe...", readyStatus: "Bereit. Ein Klick auf Flash öffnet die serielle Geräteauswahl des Browsers.", choosePort: "Wählen Sie im Browserdialog den ESP32-C3-Seriellport.",
      ...
      flashComplete: "Flash abgeschlossen. Das Gerät sollte in readerOS neu starten.", flashStopped: "Flash gestoppt. Prüfen Sie die Meldung oben, bevor Sie es erneut versuchen.", downloadBin: ".bin herunterladen", communityFlasher: "Community-Flasher",
    ...
    it: {
      ...
      homeSubtitle: "Piccoli strumenti browser per readerOS. Tutto viene eseguito localmente nel browser.", latestFirmware: "Firmware più recente: 1.0.0.1-readeros", homeStats: "Editor statistiche",
      flashEyebrow: "Installer nel browser", flashTitle: "Flash readerOS", flashSubtitle: "Installa l'ultimo firmware readerOS sul tuo Xteink X3/X4 da Chrome o Edge usando Web Serial. Scrive la partizione app inattiva e poi avvia da quella.",
      ...
      flashButton: "Flash firmware readerOS", flashing: "Flash in corso...", readyStatus: "Pronto. Premendo Flash si aprirà il selettore della porta seriale del browser.", choosePort: "Scegli la porta seriale ESP32-C3 nel prompt del browser.",
      ...
      flashComplete: "Flash completato. Il dispositivo dovrebbe riavviarsi in readerOS.", flashStopped: "Flash interrotto. Controlla il messaggio sopra prima di riprovare.", downloadBin: "Scarica .bin", communityFlasher: "Flasher community",
    ...
    pt: {
      ...
      homeSubtitle: "Pequenas ferramentas de navegador para readerOS. Tudo roda localmente no seu navegador.", latestFirmware: "Firmware mais recente: 1.0.0.1-readeros", homeStats: "Editor de estatísticas",
      flashEyebrow: "Instalador no navegador", flashTitle: "Gravar readerOS", flashSubtitle: "Instale o firmware readerOS mais recente no seu Xteink X3/X4 pelo Chrome ou Edge usando Web Serial. Ele grava a partição de app inativa e depois muda o boot para ela.",
      ...
      flashButton: "Gravar firmware readerOS", flashing: "Gravando...", readyStatus: "Pronto. Clicar em Flash abrirá o seletor de dispositivo serial do navegador.", choosePort: "Escolha a porta serial ESP32-C3 no prompt do navegador.",
      ...
      flashComplete: "Flash concluído. O dispositivo deve reiniciar no readerOS.", flashStopped: "Flash interrompido. Verifique a mensagem acima antes de tentar de novo.", downloadBin: "Baixar .bin", communityFlasher: "Flasher da comunidade",
    ...
    nl: {
      ...
      homeSubtitle: "Kleine browsertools voor readerOS. Alles draait lokaal in je browser.", latestFirmware: "Nieuwste firmware: 1.0.0.1-readeros", homeStats: "Statistiekeditor",
      flashEyebrow: "Browserinstallatie", flashTitle: "readerOS flashen", flashSubtitle: "Installeer de nieuwste readerOS-firmware op je Xteink X3/X4 vanuit Chrome of Edge met Web Serial. De inactieve app-partitie wordt geschreven en daarna als bootdoel ingesteld.",
      ...
      flashButton: "readerOS-firmware flashen", flashing: "Flashen...", readyStatus: "Klaar. Klik op Flash om de seriële apparaatkiezer van de browser te openen.", choosePort: "Kies de ESP32-C3 seriële poort in de browsermelding.",
      ...
      flashComplete: "Flash voltooid. Het apparaat zou in readerOS moeten herstarten.", flashStopped: "Flash gestopt. Controleer het bericht hierboven voordat je opnieuw probeert.", downloadBin: ".bin downloaden", communityFlasher: "Communityflasher",
  ...
  Object.assign(messages, {
    be: {
      navHome: "Галоўная", navStats: "Рэдактар статыстыкі", darkMode: "Цёмны рэжым", lightMode: "Светлы рэжым", homeSubtitle: "Невялікія браузерныя інструменты для readerOS. Усё працуе лакальна ў вашым браузеры.", latestFirmware: "Апошняя прашыўка: 1.0.0.1-readeros", homeStats: "Рэдактар статыстыкі",
      flashEyebrow: "Усталёўшчык у браузеры", flashTitle: "Прашыць readerOS", flashSubtitle: "Усталюйце апошнюю прашыўку readerOS на Xteink X3/X4 з Chrome або Edge праз Web Serial. Яна запісвае неактыўны app-раздзел і пераключае загрузку на яго.",
      ...
      latestPackage: "Апошні пакет прашыўкі", flashWarning: "Выкарыстоўвайце на сваю рызыку. Прашыўка кастомнага firmware можа не атрымацца, калі кабель адключыцца або прылада страціць сілкаванне.", unsupported: "Web Serial недаступны ў гэтым браузеры. Выкарыстоўвайце Chrome або Edge на камп'ютары або спампуйце binary уручную.", flashButton: "Прашыць readerOS", flashing: "Прашыўка...", readyStatus: "Гатова. Націск Flash адкрые выбар серыйнай прылады ў браузеры.", choosePort: "Выберыце серыйны порт ESP32-C3 у акне браузера.", openingConnection: "Адкрыццё злучэння з bootloader...", partitionOk: "Знойдзена стандартная OTA табліца раздзелаў CrossPoint/Xteink.", fetchingFirmware: "Спампоўваецца пакет прашыўкі...",
      firmwareDownloadFailed: "Не ўдалося спампаваць прашыўку", firmwareTooLarge: "Прашыўка занадта вялікая для app-раздзела: {size}.", firmwareTooSmall: "Прашыўка выглядае занадта малой. Падазроны файл не будзе прашыты.", currentBootTarget: "Бягучая загрузка: {current}. Наступная мэта прашыўкі: {target}.", writingOffset: "Запіс у offset {offset}...", partitionUnexpected: "Нечаканая канфігурацыя раздзелаў. Гэты браузерны flasher падтрымлівае толькі стандартную OTA табліцу CrossPoint/Xteink.", unknownFlashError: "Невядомая памылка прашыўкі", flashComplete: "Прашыўка завершана. Прылада павінна запусціцца ў readerOS.", flashStopped: "Прашыўка спынена. Праверце паведамленне вышэй перад паўторнай спробай.", downloadBin: "Спампаваць .bin", communityFlasher: "Community flasher", flashNote: "Аўтаматычны flasher выкарыстоўвае копію прашыўкі, апублікаваную з гэтай старонкай. Кнопка спампоўкі выкарыстоўвае asset з GitHub release.", manualTitle: "Ручная прашыўка праз PlatformIO", manualText: "Для dev-зборак клануйце repo, задайце upload port і выкарыстоўвайце PlatformIO.", stepPending: "Чакае", stepRunning: "Выконваецца", stepDone: "Гатова", stepFailed: "Памылка", stepConnect: "Падключыць прыладу", stepPartition: "Праверыць табліцу раздзелаў", stepDownload: "Спампаваць прашыўку", stepReadOtadata: "Прачытаць otadata", stepFlashApp: "Прашыць app-раздзел", stepFlashOtadata: "Прашыць otadata", stepReset: "Перазапусціць прыладу"
    },
    kk: {
      navHome: "Басты бет", navStats: "Статистика редакторы", darkMode: "Қараңғы режим", lightMode: "Жарық режим", homeSubtitle: "readerOS үшін шағын браузер құралдары. Барлығы браузерде жергілікті орындалады.", latestFirmware: "Соңғы firmware: 1.0.0.1-readeros", homeStats: "Статистика редакторы",
      flashEyebrow: "Браузердегі орнатқыш", flashTitle: "readerOS flash", flashSubtitle: "Соңғы readerOS firmware нұсқасын Xteink X3/X4 құрылғысына Chrome немесе Edge арқылы Web Serial көмегімен орнатыңыз. Ол белсенді емес app бөлімін жазады және boot-ты соған ауыстырады.",
  ...
  Object.assign(messages, {
    cs: {
      ...
      latestPackage: "Nejnovější balíček firmwaru", flashWarning: "Použití na vlastní riziko. Flash vlastního firmwaru může selhat, pokud se odpojí kabel nebo zařízení ztratí napájení.", unsupported: "Web Serial není v tomto prohlížeči dostupný. Použijte Chrome nebo Edge na desktopu, nebo stáhněte binárku ručně.", flashButton: "Flashovat firmware readerOS", flashing: "Flashování...", readyStatus: "Připraveno. Kliknutí na Flash otevře výběr sériového zařízení v prohlížeči.", choosePort: "Vyberte sériový port ESP32-C3 v dialogu prohlížeče.", openingConnection: "Otevírání spojení s bootloaderem...", partitionOk: "Nalezena výchozí OTA tabulka oddílů CrossPoint/Xteink.", fetchingFirmware: "Stahování balíčku firmwaru...",
      firmwareDownloadFailed: "Stažení firmwaru selhalo", firmwareTooLarge: "Firmware je pro app oddíl příliš velký: {size}.", firmwareTooSmall: "Firmware vypadá příliš malý. Podezřelý soubor nebude flashován.", currentBootTarget: "Aktuální boot: {current}. Další cíl flashování: {target}.", writingOffset: "Zápis na offset {offset}...", partitionUnexpected: "Neočekávaná konfigurace oddílů. Tento prohlížečový flasher podporuje jen zařízení s výchozí OTA tabulkou CrossPoint/Xteink.", unknownFlashError: "Neznámá chyba flashování", flashComplete: "Flash dokončen. Zařízení by mělo nabootovat do readerOS.", flashStopped: "Flash zastaven. Před dalším pokusem zkontrolujte zprávu výše.", downloadBin: "Stáhnout .bin", communityFlasher: "Komunitní flasher", flashNote: "Automatický flasher používá kopii firmwaru publikovanou s touto stránkou. Tlačítko stažení používá asset z GitHub release.", manualTitle: "Ruční flash přes PlatformIO", manualText: "Pro vývojové buildy naklonujte repo, nastavte upload port a použijte PlatformIO.", stepPending: "Čeká", stepRunning: "Běží", stepDone: "Hotovo", stepFailed: "Chyba", stepConnect: "Připojit zařízení", stepPartition: "Ověřit tabulku oddílů", stepDownload: "Stáhnout firmware", stepReadOtadata: "Číst oddíl otadata", stepFlashApp: "Flashovat app oddíl", stepFlashOtadata: "Flashovat oddíl otadata", stepReset: "Resetovat zařízení"
    },
    da: {
      navHome: "Hjem", navStats: "Statistikeditor", darkMode: "Mørk tilstand", lightMode: "Lys tilstand", homeSubtitle: "Små browserværktøjer til readerOS. Alt kører lokalt i din browser.", latestFirmware: "Nyeste firmware: 1.0.0.1-readeros", homeStats: "Statistikeditor",
      flashEyebrow: "Browserbaseret installer", flashTitle: "Flash readerOS", flashSubtitle: "Installer den nyeste readerOS-firmware på din Xteink X3/X4 fra Chrome eller Edge med Web Serial. Den skriver den inaktive app-partition og skifter derefter boot til den.",
    ...
    pl: {
      ...
      latestPackage: "Najnowszy pakiet firmware", flashWarning: "Używasz na własne ryzyko. Flash niestandardowego firmware może się nie udać, jeśli kabel zostanie odłączony lub urządzenie straci zasilanie.", unsupported: "Web Serial nie jest dostępny w tej przeglądarce. Użyj Chrome lub Edge na komputerze desktopowym albo pobierz binarkę ręcznie.", flashButton: "Flashuj firmware readerOS", flashing: "Flashowanie...", readyStatus: "Gotowe. Kliknięcie Flash otworzy wybór urządzenia szeregowego w przeglądarce.", choosePort: "Wybierz port szeregowy ESP32-C3 w oknie przeglądarki.", openingConnection: "Otwieranie połączenia z bootloaderem...", partitionOk: "Znaleziono domyślną tablicę partycji OTA CrossPoint/Xteink.", fetchingFirmware: "Pobieranie pakietu firmware...",
      firmwareDownloadFailed: "Pobieranie firmware nie powiodło się", firmwareTooLarge: "Firmware jest za duży dla partycji app: {size}.", firmwareTooSmall: "Firmware wygląda na zbyt mały. Podejrzany plik nie zostanie flashowany.", currentBootTarget: "Aktualny boot: {current}. Następny cel flashowania: {target}.", writingOffset: "Zapis do offsetu {offset}...", partitionUnexpected: "Nieoczekiwana konfiguracja partycji. Ten flasher obsługuje tylko urządzenia z domyślną tabelą OTA CrossPoint/Xteink.", unknownFlashError: "Nieznany błąd flashowania", flashComplete: "Flash zakończony. Urządzenie powinno uruchomić readerOS.", flashStopped: "Flash zatrzymany. Sprawdź komunikat powyżej przed kolejną próbą.", downloadBin: "Pobierz .bin", communityFlasher: "Flasher społeczności", flashNote: "Automatyczny flasher używa kopii firmware opublikowanej z tą stroną. Przycisk pobierania używa assetu z release GitHub.", manualTitle: "Ręczny flash przez PlatformIO", manualText: "Dla buildów deweloperskich sklonuj repo, ustaw port uploadu i użyj PlatformIO.", stepPending: "Oczekuje", stepRunning: "W toku", stepDone: "Gotowe", stepFailed: "Błąd", stepConnect: "Połącz z urządzeniem", stepPartition: "Sprawdź tablicę partycji", stepDownload: "Pobierz firmware", stepReadOtadata: "Czytaj partycję otadata", stepFlashApp: "Flashuj partycję app", stepFlashOtadata: "Flashuj partycję otadata", stepReset: "Resetuj urządzenie"
    },
    ru: {
      navHome: "Главная", navStats: "Редактор статистики", darkMode: "Тёмный режим", lightMode: "Светлый режим", homeSubtitle: "Небольшие браузерные инструменты для readerOS. Всё работает локально в браузере.", latestFirmware: "Последняя прошивка: 1.0.0.1-readeros", homeStats: "Редактор статистики",
      flashEyebrow: "Установщик в браузере", flashTitle: "Прошить readerOS", flashSubtitle: "Установите последнюю прошивку readerOS на Xteink X3/X4 из Chrome или Edge через Web Serial. Она записывает неактивный app-раздел и переключает загрузку на него.",
  ...
  const localizedTools = {
    be: {
      ...
      toolsSubtitle: "Браўзерныя інструменты для readerOS і карысныя знешнія сэрвісы для Xteink.",
      toolsStatsTitle: "Рэдактар статыстыкі чытання readerOS",
    ...
    ca: {
      navTools: "Eines",
      navSupport: "Suport",
      toolsSubtitle: "Eines de navegador per a readerOS i utilitats externes útils per al flux Xteink.",
      toolsStatsTitle: "Editor d'estadístiques de lectura readerOS",
    ...
    cs: {
      navTools: "Nástroje",
      navSupport: "Podpora",
      toolsSubtitle: "Nástroje v prohlížeči pro readerOS a užitečné externí služby pro Xteink.",
      toolsStatsTitle: "Editor statistik čtení readerOS",
    ...
    da: {
      navTools: "Værktøjer",
      navSupport: "Støtte",
      toolsSubtitle: "Browserværktøjer til readerOS og nyttige eksterne tjenester til Xteink.",
      toolsStatsTitle: "readerOS læsestatistik-editor",
    ...
    nl: {
      ...
      navSupport: "Steun",
      toolsSubtitle: "Browserhulpmiddelen voor readerOS en nuttige externe diensten voor Xteink.",
      toolsStatsTitle: "readerOS leesstatistieken-editor",
      ...
      navTools: "Työkalut",
      navSupport: "Tuki",
      toolsSubtitle: "Selaintyökaluja readerOSille ja hyödyllisiä ulkoisia palveluja Xteinkille.",
      toolsStatsTitle: "readerOS-lukutilastojen editori",
    ...
    fr: {
      navTools: "Outils",
      navSupport: "Soutien",
      toolsSubtitle: "Outils de navigateur pour readerOS et services externes utiles pour Xteink.",
      toolsStatsTitle: "Éditeur de statistiques de lecture readerOS",
    ...
    de: {
      ...
      toolsSubtitle: "Browser-Werkzeuge für readerOS und nützliche externe Dienste für Xteink.",
      toolsStatsTitle: "readerOS Lesestatistik-Editor",
    ...
    hu: {
      ...
      toolsSubtitle: "Böngészős eszközök readerOShez és hasznos külső szolgáltatások Xteinkhez.",
      toolsStatsTitle: "readerOS olvasási statisztika szerkesztő",
    ...
    it: {
      navTools: "Strumenti",
      navSupport: "Supporto",
      toolsSubtitle: "Strumenti browser per readerOS e servizi esterni utili per Xteink.",
      toolsStatsTitle: "Editor statistiche di lettura readerOS",
    ...
    kk: {
      navTools: "Құралдар",
      navSupport: "Қолдау",
      toolsSubtitle: "readerOS үшін браузер құралдары және Xteink үшін пайдалы сыртқы сервистер.",
      toolsStatsTitle: "readerOS оқу статистикасы редакторы",
    ...
    lt: {
      ...
      toolsSubtitle: "Naršyklės įrankiai readerOS ir naudingi išoriniai servisai Xteink.",
      toolsStatsTitle: "readerOS skaitymo statistikos redaktorius",
    ...
    pl: {
      navTools: "Narzędzia",
      navSupport: "Wesprzyj",
      toolsSubtitle: "Narzędzia przeglądarkowe dla readerOS i przydatne zewnętrzne usługi dla Xteink.",
      toolsStatsTitle: "Edytor statystyk czytania readerOS",
    ...
    pt: {
      ...
      navSupport: "Apoiar",
      toolsSubtitle: "Ferramentas de navegador para readerOS e serviços externos úteis para Xteink.",
      toolsStatsTitle: "Editor de estatísticas de leitura readerOS",
    ...
    ro: {
      navTools: "Unelte",
      navSupport: "Susține",
      toolsSubtitle: "Unelte în browser pentru readerOS și servicii externe utile pentru Xteink.",
      toolsStatsTitle: "Editor statistici de citire readerOS",
    ...
    ru: {
      ...
      toolsSubtitle: "Браузерные инструменты для readerOS и полезные внешние сервисы для Xteink.",
      toolsStatsTitle: "Редактор статистики чтения readerOS",
    ...
    si: {
      navTools: "Orodja",
      navSupport: "Podpora",
      toolsSubtitle: "Brskalniška orodja za readerOS in uporabne zunanje storitve za Xteink.",
      toolsStatsTitle: "Urejevalnik bralnih statistik readerOS",
    ...
    sv: {
      navTools: "Verktyg",
      navSupport: "Stöd",
      toolsSubtitle: "Webbläsarverktyg för readerOS och användbara externa tjänster för Xteink.",
      toolsStatsTitle: "readerOS lässtatistikredigerare",
    ...
    tr: {
      navTools: "Araçlar",
      navSupport: "Destek",
      toolsSubtitle: "readerOS için tarayıcı araçları ve Xteink için yararlı harici servisler.",
      toolsStatsTitle: "readerOS okuma istatistikleri düzenleyici",
    ...
    uk: {
      ...
      toolsSubtitle: "Браузерні інструменти для readerOS і корисні зовнішні сервіси для Xteink.",
      toolsStatsTitle: "Редактор статистики читання readerOS",
    ...
    vi: {
      navTools: "Công cụ",
      navSupport: "Ủng hộ",
      toolsSubtitle: "Công cụ trình duyệt cho readerOS và các dịch vụ ngoài hữu ích cho Xteink.",
      toolsStatsTitle: "Trình chỉnh sửa thống kê đọc readerOS",
  ...
  const localizedHomeCards = {
    en: {
      homeSubtitle: "Firmware, auto-flash and local browser tools for readerOS on Xteink X3/X4.",
      ...
      homeSupportBody: "Support readerOS development on Ko-fi."
    },
    es: {
      homeSubtitle: "Firmware, auto flash y herramientas locales de navegador para readerOS en Xteink X3/X4.",
      ...
      homeSupportBody: "Apoya el desarrollo de readerOS en Ko-fi."
    },
    ca: {
      homeSubtitle: "Firmware, flash automàtic i eines locals de navegador per a readerOS a Xteink X3/X4.",
      ...
      homeSupportBody: "Dona suport al desenvolupament de readerOS a Ko-fi."
    },
    fr: {
      homeSubtitle: "Firmware, flash automatique et outils locaux de navigateur pour readerOS sur Xteink X3/X4.",
      ...
      homeSupportBody: "Soutenez le développement de readerOS sur Ko-fi."
    },
    de: {
      homeSubtitle: "Firmware, Auto-Flash und lokale Browser-Werkzeuge für readerOS auf dem Xteink X3/X4.",
      ...
      homeSupportBody: "Unterstützen Sie die Entwicklung von readerOS auf Ko-fi."
    },
    it: {
      homeSubtitle: "Firmware, flash automatico e strumenti locali del browser per readerOS su Xteink X3/X4.",
      ...
      homeSupportBody: "Sostieni lo sviluppo di readerOS su Ko-fi."
    },
    pt: {
      homeSubtitle: "Firmware, flash automático e ferramentas locais de navegador para readerOS no Xteink X3/X4.",
      ...
      homeSupportBody: "Apoie o desenvolvimento do readerOS no Ko-fi."
    },
    nl: {
      homeSubtitle: "Firmware, auto-flash en lokale browserhulpmiddelen voor readerOS op Xteink X3/X4.",
      ...
      homeSupportBody: "Steun de ontwikkeling van readerOS op Ko-fi."
    },
    be: {
      homeSubtitle: "Прашыўка, аўта-flash і лакальныя браўзерныя інструменты для readerOS на Xteink X3/X4.",
      ...
      homeSupportBody: "Падтрымайце распрацоўку readerOS на Ko-fi."
    },
    cs: {
      homeSubtitle: "Firmware, automatický flash a lokální nástroje v prohlížeči pro readerOS na Xteink X3/X4.",
      ...
      homeSupportBody: "Podpořte vývoj readerOS na Ko-fi."
    },
    da: {
      homeSubtitle: "Firmware, auto-flash og lokale browserværktøjer til readerOS på Xteink X3/X4.",
      ...
      homeSupportBody: "Støt udviklingen af readerOS på Ko-fi."
    },
    fi: {
      homeSubtitle: "Firmware, automaattinen flash ja paikalliset selaintyökalut readerOSille Xteink X3/X4:ssä.",
      ...
      homeSupportBody: "Tue readerOSin kehitystä Ko-fissa."
    },
    hu: {
      homeSubtitle: "Firmware, automatikus flash és helyi böngészős eszközök readerOShez Xteink X3/X4-en.",
      ...
      homeSupportBody: "Támogasd a readerOS fejlesztését Ko-fin."
    },
    kk: {
      homeSubtitle: "Xteink X3/X4 үшін readerOS firmware, авто-flash және жергілікті браузер құралдары.",
      ...
      homeSupportBody: "readerOS әзірлеуін Ko-fi арқылы қолдаңыз."
    },
    lt: {
      homeSubtitle: "Programinė įranga, automatinis flash ir vietiniai naršyklės įrankiai readerOS Xteink X3/X4.",
      ...
      homeSupportBody: "Paremkite readerOS kūrimą Ko-fi."
    },
    pl: {
      homeSubtitle: "Firmware, auto flash i lokalne narzędzia przeglądarkowe dla readerOS na Xteink X3/X4.",
      ...
      homeSupportBody: "Wesprzyj rozwój readerOS na Ko-fi."
    },
    ro: {
      homeSubtitle: "Firmware, flash automat și unelte locale de browser pentru readerOS pe Xteink X3/X4.",
      ...
      homeSupportBody: "Susține dezvoltarea readerOS pe Ko-fi."
    },
    ru: {
      homeSubtitle: "Прошивка, авто-flash и локальные браузерные инструменты для readerOS на Xteink X3/X4.",
      ...
      homeSupportBody: "Поддержите разработку readerOS на Ko-fi."
    },
    si: {
      homeSubtitle: "Firmware, samodejni flash in lokalna brskalniška orodja za readerOS na Xteink X3/X4.",
      ...
      homeSupportBody: "Podprite razvoj readerOS na Ko-fi."
    },
    sv: {
      homeSubtitle: "Firmware, auto flash och lokala webbläsarverktyg för readerOS på Xteink X3/X4.",
      ...
      homeSupportBody: "Stöd utvecklingen av readerOS på Ko-fi."
    },
    tr: {
      homeSubtitle: "Xteink X3/X4 üzerinde readerOS için firmware, otomatik flash ve yerel tarayıcı araçları.",
      ...
      homeSupportBody: "readerOS geliştirmesini Ko-fi üzerinde destekleyin."
    },
    uk: {
      homeSubtitle: "Прошивка, авто-flash і локальні браузерні інструменти для readerOS на Xteink X3/X4.",
      ...
      homeSupportBody: "Підтримайте розробку readerOS на Ko-fi."
    },
    vi: {
      homeSubtitle: "Firmware, auto flash và công cụ trình duyệt cục bộ cho readerOS trên Xteink X3/X4.",
      ...
      homeSupportBody: "Ủng hộ phát triển readerOS trên Ko-fi."
    }
  };
  ...
  const localizedTitles = Object.fromEntries(languages.map(([language]) => [language, "readerOS"]));
